...
object Setting {
	...
	private val frgs = arrayOf(
			Data(0, "VOA慢速", "http://m.iyuba.com/voaS/index.jsp", FrgEcHtml::class.java),
			Data(1, "VOA一分钟", "http://m.iyuba.com/voaS/indexAM.jsp", FrgEcHtml::class.java),
			Data(2, "VOA视频", "http://m.iyuba.com/voaS/indexCV.jsp", FrgEcHtml::class.java),
			Data(3, "BBC六分钟", "http://m.iyuba.com/bbcwap/index.jsp?parentID=1", FrgEcHtml::class.java),
			Data(4, "BBC地道英语", "http://m.iyuba.com/bbcwap/index.jsp?parentID=5", FrgEcHtml::class.java),
			Data(5, "BBC新闻", "http://m.iyuba.com/bbcwap/index.jsp?parentID=3", FrgEcHtml::class.java),
